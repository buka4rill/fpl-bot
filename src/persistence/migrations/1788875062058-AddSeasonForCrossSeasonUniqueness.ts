...
export class AddSeasonForCrossSeasonUniqueness1788875062058 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "proposals" ADD "season" character varying`,
    );
    await queryRunner.query(
      `UPDATE "proposals" SET "season" = ${SEASON_FROM_DEADLINE('deadlineAt')}`,
    );
    await queryRunner.query(
      `ALTER TABLE "proposals" ALTER COLUMN "season" SET NOT NULL`,
    );

    // gameweeks: has its own deadlineAt, so backfill directly.
    await queryRunner.query(
      `ALTER TABLE "gameweeks" ADD "season" character varying`,
    );
    await queryRunner.query(
      `UPDATE "gameweeks" SET "season" = ${SEASON_FROM_DEADLINE('deadlineAt')}`,
    );
    await queryRunner.query(
      `ALTER TABLE "gameweeks" ALTER COLUMN "season" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "gameweeks" DROP CONSTRAINT "PK_5838cf0a51140681c92c28e8114"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gameweeks" ADD CONSTRAINT "PK_e5be1e1740f7d1f97aa4a442dde" PRIMARY KEY ("id", "season")`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "player_snapshots" ADD "season" character varying`,
    );
    await queryRunner.query(
      `UPDATE "player_snapshots" ps SET "season" = g."season" FROM "gameweeks" g WHERE g."id" = ps."gameweekId"`,
    );
    ...
    await queryRunner.query(
      `UPDATE "player_snapshots" SET "season" = (SELECT "season" FROM "gameweeks" LIMIT 1) WHERE "season" IS NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "player_snapshots" ALTER COLUMN "season" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "player_snapshots" DROP CONSTRAINT "PK_d0c0920b5915e40d4ae8b8c95bc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "player_snapshots" ADD CONSTRAINT "PK_31aaf8f10e2a352876f7868eda3" PRIMARY KEY ("gameweekId", "playerId", "season")`,
    );

    await queryRunner.query(
      `CREATE INDEX "IDX_c45505a90a8d2d1bb4617b2d36" ON "proposals" ("season", "gameweekId") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c45505a90a8d2d1bb4617b2d36"`,
    );
    await queryRunner.query(
      `ALTER TABLE "player_snapshots" DROP CONSTRAINT "PK_31aaf8f10e2a352876f7868eda3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "player_snapshots" ADD CONSTRAINT "PK_d0c0920b5915e40d4ae8b8c95bc" PRIMARY KEY ("gameweekId", "playerId")`,
    );
    await queryRunner.query(
      `ALTER TABLE "player_snapshots" DROP COLUMN "season"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gameweeks" DROP CONSTRAINT "PK_e5be1e1740f7d1f97aa4a442dde"`,
    );
    await queryRunner.query(
      `ALTER TABLE "gameweeks" ADD CONSTRAINT "PK_5838cf0a51140681c92c28e8114" PRIMARY KEY ("id")`,
    );
